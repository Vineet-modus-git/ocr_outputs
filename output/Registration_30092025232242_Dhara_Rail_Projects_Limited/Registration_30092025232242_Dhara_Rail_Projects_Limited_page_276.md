...
In terms of the SEBI FPI Regulations, the issue of Equity Shares to a single FPI including its investor group (which means multiple entities registered as FPIs and directly or indirectly having common ownership of more than 50% or common control) must be below 10% of the post-Issue paid-up capital.
...
An FPI is required to ensure that the transfer of an offshore derivative instruments issued by or on behalf of it, is subject to (a) the transfer being made to persons which fulfil the criteria provided under the SEBI FPI Regulations (as mentioned above from points (a) to (d)); and (b) prior consent of the FPI is obtained for such transfer, except in cases, where the persons to whom the offshore derivative instruments are to be transferred, are pre-approved by the FPI.
