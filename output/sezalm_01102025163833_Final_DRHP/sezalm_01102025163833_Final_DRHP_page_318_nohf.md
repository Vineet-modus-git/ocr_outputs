...
* In case of Bidders (excluding NIIs and QIBs) Bidding at cut-off price, the Bidders may instruct the SCSBs to block Bid Amount based on the Cap Price less Discount (if applicable).

* For details of the timing on acceptance and upload of Bids in the Stock Exchange platform Bidders are requested to refer to the DRHP.
...
* Bids for number of Equity Shares which are not in multiples of Equity Shares as specified in the DRHP;
