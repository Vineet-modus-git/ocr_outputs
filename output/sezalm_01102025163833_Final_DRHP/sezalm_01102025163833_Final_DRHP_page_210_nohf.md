...
In estimating the fair value of an asset or a liability, the Group uses market-observable data to the extent it is available. Where Level 1 inputs are not available, fair values are determined on the basis of the third-party valuations. The models used to determine fair values including estimates/ judgements involved are validated and periodically reviewed by the management. Refer note 41 to the financial statements.
