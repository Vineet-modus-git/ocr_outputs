...
Depreciation is calculated on a Written Down Value method over the useful life and in the manner prescribed in Schedule II to the Act. However, where the Management's estimate of the remaining useful life of the assets on a review subsequent to the time of acquisition is different, then depreciation is provided over the remaining useful life based on the revised useful life. As the nature and use of the solar plant is distinguishable from other plant and machinery, it is classified