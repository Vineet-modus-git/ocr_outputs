...
Financial assets and financial liabilities are offset and the net amount is reported in the Restated Ind AS Summary Statement of Assets and Liabilities if there is a currently enforceable legal right to offset the recognised amounts and there is an intention to settle on a net basis, to realise the assets and settle the liabilities simultaneously.