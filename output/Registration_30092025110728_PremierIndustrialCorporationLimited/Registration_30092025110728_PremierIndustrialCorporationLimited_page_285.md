...
The Company 12ecognized government grants only when there is reasonable assurance that the conditions attached to them will be complied with, and the grants will be received. When the grant relates to an expense item, it is 12ecognized as income on a systematic basis over the periods that the related costs, for which it is intended to compensate, are expensed off. When the grant relates to an asset, the Company deducts such grant amount from the carrying amount of the asset.
