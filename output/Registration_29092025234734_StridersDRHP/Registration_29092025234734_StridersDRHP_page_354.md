...
The entire Issue price of Rs. [●] per share is payable on application. In case of allotment of lesser number of Equity Shares than the number applied, the Registrar shall instruct the SCSBs to unblock the excess amount paid on Application to the Bidders.
