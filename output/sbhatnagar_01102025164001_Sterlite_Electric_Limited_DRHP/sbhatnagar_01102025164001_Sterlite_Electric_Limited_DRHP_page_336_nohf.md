...
The Restated Consolidated Summary Statements comprise the financial statements of the Holding Company, its Subsidiaries, Joint Ventures and an Associate as at 31 March 2025, 31 March 2024 and 31 March 2023. Control is achieved when the Group is exposed, or has rights, to variable returns from its involvement with the investee and has the ability to affect those returns through its power over the investee. Specifically, the Group controls an investee if and only if the Group has:
